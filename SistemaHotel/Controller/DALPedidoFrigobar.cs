...
{
    public static class DALPedidoFrigobar
    {
        ...
        public static void inserirPedidoFrigobar(PedidoFrigobar ped)
        {
            using (SqlConnection connection = new SqlConnection(cnn))
            {
                using (SqlCommand cmd = new SqlCommand(@"INSERT INTO [dbo].[PEDIDO]
                                                       ...
                                                       ,[DATA_ABERTURA])
                                                        VALUES
                                                        (@ID_STATUS,@ID_CLIENTE,NULLIF(@ID_ADM,''),@VALOR_TOTAL,@DATA_ABERTURA)", connection))
                {
