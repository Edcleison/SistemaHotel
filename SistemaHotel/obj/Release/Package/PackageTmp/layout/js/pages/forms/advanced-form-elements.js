$(function () {
    ...
    //Time
    $demoMaskedInput.find('.time12').inputmask('hh:mm', { placeholder: '__:__', alias: 'time12', hourFormat: '12' });
    ...
    //Phone Number
    $demoMaskedInput.find('.phone-number').inputmask('(99) 9999-9999', { placeholder: '(__) ____-____' });
