(function (g) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (i) { return g(i, window, document) }) : "object" === typeof exports ? module.exports = function (i, j, t, u) { i || (i = window); if (!j || !j.fn.dataTable) j = require("datatables.net")(i, j).$; j.fn.dataTable.Buttons || require("datatables.net-buttons")(i, j); return g(j, i, i.document, t, u) } : g(jQuery, window, document) })(function (g, i, j, t, u, o) {
    ...
    r.ext.buttons.copyHtml5 = {
            ...
            var a = L(b, c), f = a.str, d = g("<div/>").css({ height: 1, width: 1, overflow: "hidden", position: "fixed", top: 0, left: 0 }); c.customize && (f = c.customize(f, c)); c = g("<textarea readonly/>").val(f).appendTo(d); if (j.queryCommandSupported("copy")) {
                d.appendTo(b.table().container()); c[0].focus(); c[0].select(); try {
                    var e = j.execCommand("copy"); d.remove(); if (e) {
                        ...
                        "Copiar para a Area de Transferencia"), b.i18n("buttons.copySuccess", { 1: "Copiar uma linha para o Area de transferencia", _: "Copiadas %d linhas para a Area de Transferencia" }, a.rows), 2E3); return
                    }
                } catch (h) { }
            } e = g("<span>" + b.i18n("buttons.copyKeys", "Pressione <i>ctrl</i> ou <i>?</i> + <i>C</i> para copiar os dados da tabela<br>para Area de Transferencia do sistema.<br><br>Para cancelar, clique na mensagem ou pressione ESC.") + "</span>").append(d); b.buttons.info(b.i18n("buttons.copyTitle", "Copiar para Area de Transferencia"), e, 0); c[0].focus(); c[0].select(); var l = g(e).closest(".dt-button-info"), i = function () {
        ...
        }, title: "*", filename: "*", extension: ".pdf", exportOptions: {}, orientation: "landscape", pageSize: "A4", header: !0, footer: !1, message: null, customize: null, download: "download"
    }; return r.Buttons
});
